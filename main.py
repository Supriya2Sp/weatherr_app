...
def get_weather_data(location):
    ...
    url = f"https://www.google.com/search?q=weather+{location.replace(' ','')}+&hl=en"
...
layout = [
    [sg.Input(key = '-INPUT-',expand_x = True),sg.Button('Enter', button_color = '#000000')],
